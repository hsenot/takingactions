...
SELECT pg_catalog.setval('task_discarded_id_seq', 6082, true);
...
SELECT pg_catalog.setval('task_id_seq', 299, true);
...
SELECT pg_catalog.setval('task_undertaken_id_seq', 279, true);
