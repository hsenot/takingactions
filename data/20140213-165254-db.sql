...
SELECT pg_catalog.setval('task_discarded_id_seq', 4601, true);
...
SELECT pg_catalog.setval('task_id_seq', 281, true);
...
SELECT pg_catalog.setval('task_undertaken_id_seq', 261, true);
