...
SELECT pg_catalog.setval('task_discarded_id_seq', 1761, true);
...
SELECT pg_catalog.setval('task_id_seq', 164, true);
...
SELECT pg_catalog.setval('task_undertaken_id_seq', 135, true);
