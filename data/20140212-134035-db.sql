...
SELECT pg_catalog.setval('task_discarded_id_seq', 4022, true);
...
SELECT pg_catalog.setval('task_id_seq', 246, true);
...
SELECT pg_catalog.setval('task_undertaken_id_seq', 223, true);
